          ...
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <span className="text-xl font-black tracking-tighter text-white">Gitdocs</span>
                ...
                <div className="flex items-center gap-2 text-sm font-medium text-white hover:text-white/80 transition-colors cursor-pointer">
                  <img src="https://avatars.githubusercontent.com/u/9919?s=40&v=4" alt="User Org" className="w-5 h-5 rounded-full border border-white/20" />
                  <span>octocat</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                >
                  <div className="px-4 py-3 border-b border-white/5">
                    <p className="text-sm text-white font-medium">octocat</p>
                    <p className="text-xs text-[#a1a1a1] truncate">octocat@github.com</p>
                  </div>
                  <div className="py-1">
                  ...
                  <div className="py-1 border-t border-white/5">
                    <button className="w-full text-left px-4 py-2 text-sm text-[#ffb4ab] hover:bg-[#ffb4ab]/10 flex items-center gap-2 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
              <div className="relative w-full sm:w-[320px]">
                ...
                <input type="text" placeholder="Search repositories..." className="w-full bg-[#0d1117] border border-white/10 text-white text-sm rounded-lg focus:ring-1 focus:ring-white/30 focus:border-white/30 block pl-10 p-2.5 transition-all placeholder-white/30" />
              </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-bold text-white tracking-tight flex items-center gap-2">
                          awesome-project
                          <span className="material-symbols-outlined text-[14px] text-white/0 group-hover:text-white/40 transition-all -ml-2 group-hover:ml-0">arrow_outward</span>
                        </h3>
